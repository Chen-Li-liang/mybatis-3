...
/**
 * 基于Java XPath解析器，用于解析Mybatis mybatis-config.xml 和 **Mapper.xml等配置文件
...
public class XPathParser {
  ...
  /**
   * XML 被解析后，生成的org.w3c.dom.Document 对象
   */
  ...
  public String evalString(Object root, String expression) {
    ...
    // <2>基于variables替换动态值，如果 result 为动态值
